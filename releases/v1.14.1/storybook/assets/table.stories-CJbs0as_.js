import{e as ve,u as r}from"./renderer-suOrDz0O.js";import"./_commonjsHelpers-BosuxZz1.js";const Se=e=>ve.render("table-wrapper",e),ye=`
...
`,n={caption:"Titre du tableau (caption)",noCaption:!1,captionBottom:!1,bordered:!1,noScroll:!1,multiline:!1,hasHeader:!1,hasHeaderSegmented:!0,hasHeaderDetails:!0,hasHeaderButtons:!0,hasFooter:!1,hasFooterSelect:!0,hasFooterPagination:!0,hasFooterButtons:!0,size:"md",table:i()},ze=e=>{const t={size:e.size||n.size,table:{caption:e.caption||n.caption,captionDetail:e.captionDetail||n.captionDetail,thead:e.table.thead||n.table.thead,tbodies:e.table.tbodies||n.table.tbodies,id:e.id||void 0}};if(e.noCaption===!0&&(t.noCaption=e.noCaption),e.captionBottom===!0&&(t.captionBottom=e.captionBottom),e.bordered===!0&&(t.bordered=e.bordered),e.noScroll===!0&&(t.noScroll=e.noScroll),e.multiline===!0&&(t.multiline=e.multiline),e.hasHeader===!0){let a="";e.hasHeaderSegmented===!0&&(a+=ke),e.hasHeaderDetails===!0&&(a+=ye),e.hasHeaderButtons===!0&&(a+=_e),t.header=a}if(e.hasFooter===!0){let a="";e.hasFooterSelect===!0&&(a+=we),e.hasFooterPagination===!0&&(a+=Te),e.hasFooterButtons===!0&&(a+=qe),t.footer=a}return t},Me=e=>Se({table:ze(e)}),Ie={id:"table",title:"DSFR/Component/Table",render:Me,argTypes:Ae,args:n},c={tags:["!autodocs"],args:{id:r("table")}},d={tags:["autodocs","!dev"],args:{id:r("table")}},u={tags:["autodocs","!dev"],args:{id:r("table"),size:"sm"}},p={tags:["autodocs","!dev"],args:{id:r("table"),size:"md"}},b={tags:["autodocs","!dev"],args:{id:r("table"),size:"lg"}},m={tags:["autodocs","!dev"],args:{id:r("table"),bordered:!0}},f={tags:["autodocs","!dev"],args:{id:r("table"),noScroll:!0}},g={tags:["autodocs","!dev"],args:{id:r("table"),multiline:!0}},h={tags:["autodocs","!dev"],args:{id:r("table"),multiline:!0,table:Le()}},x={tags:["autodocs","!dev"],args:{id:r("table"),table:xe()}},v={tags:["autodocs","!dev"],parameters:{docs:{description:{story:"La première colonne est fixe à partir du breakpoint `md`. Existe aussi avec les breakpoints `sm` et `lg`"}}},args:{id:r("table"),table:xe("md")}},S={tags:["autodocs","!dev"],args:{id:r("table"),table:Fe()}},y={tags:["autodocs","!dev"],args:{id:r("table"),table:Ce()}},_={tags:["autodocs","!dev"],args:{id:r("table"),bordered:!0,captionDetail:He(),table:Ee()}},k={tags:["autodocs","!dev"],args:{id:r("table"),table:De()}};var q,A,L;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {
    id: uniqueId('table')
  }
}`,...(L=(A=c.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var F,C,E;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table')
  }
}`,...(E=(C=d.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var D,H,z;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    size: 'sm'
  }
}`,...(z=(H=u.parameters)==null?void 0:H.docs)==null?void 0:z.source}}};var M,P,B;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    size: 'md'
...
}`,...(G=(j=b.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var V,$,J;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    bordered: true
  }
}`,...(J=($=m.parameters)==null?void 0:$.docs)==null?void 0:J.source}}};var N,R,K;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    noScroll: true
  }
}`,...(K=(R=f.parameters)==null?void 0:R.docs)==null?void 0:K.source}}};var O,U,Q;g.parameters={...g.parameters,docs:{...(O=g.parameters)==null?void 0:O.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    multiline: true
...
}`,...(be=(pe=_.parameters)==null?void 0:pe.docs)==null?void 0:be.source}}};var me,fe,ge;k.parameters={...k.parameters,docs:{...(me=k.parameters)==null?void 0:me.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    table: getMiscellaneousTableArgs()
  }
}`,...(ge=(fe=k.parameters)==null?void 0:fe.docs)==null?void 0:ge.source}}};const je=["TableStory","DefaultStory","SizeSMStory","SizeMDStory","SizeLGStory","VerticalBordersStory","NoScrollStory","MultilineStory","MultilineColMinSizeStory","FixedColumnStory","FixedColumnFromMDStory","SelectableTableStory","SelectableTableSelectedLineStory","ComplexTableStory","MiscellaneousTableStory"];export{_ as ComplexTableStory,d as DefaultStory,v as FixedColumnFromMDStory,x as FixedColumnStory,k as MiscellaneousTableStory,h as MultilineColMinSizeStory,g as MultilineStory,f as NoScrollStory,y as SelectableTableSelectedLineStory,S as SelectableTableStory,b as SizeLGStory,p as SizeMDStory,u as SizeSMStory,c as TableStory,m as VerticalBordersStory,je as __namedExportsOrder,Ie as default};
