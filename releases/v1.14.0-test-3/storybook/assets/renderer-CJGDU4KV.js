...
`,k.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),k}var D=e.client?s:function(Q){var fe=function(he,Z){var F=l.shallowCopy(l.createNullProtoObjWherePossible(),Q);return Z&&(F=l.shallowCopy(F,Z)),be(he,e)(F)};return s.apply(e.context,[Q||l.createNullProtoObjWherePossible(),b,fe,H])};if(e.filename&&typeof Object.defineProperty=="function"){var M=e.filename,ge=c.basename(M,c.extname(M));try{Object.defineProperty(D,"name",{value:ge,writable:!1,enumerable:!1,configurable:!0})}catch{}}return D},generateSource:function(){var t=this.opts;t.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
...
`)}},i.escapeXML=l.escapeXML,i.__express=i.renderFile,i.VERSION=$,i.name=g,typeof window<"u"&&(window.ejs=i)})(h);var ue=h;return ue})})(K);var dn=K.exports;const un=ve(dn);let cn=0;const pn=a=>`${a}-${cn++}`,mn=`
...
${Ce}
`;class bn{constructor(n,h){this._names=n,this._template=h.replace(/eval\(include\('(..\/)*(core\/)?index.ejs'\)\);/,mn)}get names(){return this._names}retrieve(n){return this._names.some(h=>n.match(new RegExp(`^(.*/)?${h}(.ejs)?$`))!==null)}render(n){return un.render(this._template,n)}}class gn{constructor(){this._templates=[]}add(n,h){if(n.some(j=>this._templates.find(A=>A.names.includes(j))))throw new Error(`One of the template names [${n}] already exists`);const _=new bn(n,h);this._templates.push(_)}render(n,h){const _=this._templates.find(j=>j.retrieve(n));return _?(h.include=(j,A)=>this.render(j,A),h.uniqueId=pn,h.getI18nText=(j,A="global")=>this.getI18nText(j,A),h.locale="fr",_.render(h).trim()):""}getI18nText(n,h="global"){const _=on[h].fr,A=n.split(".").reduce((E,T)=>E[T],_);return A||n}}const fn=`<%#
# paramètres action
...
<<%= actionMarkup %> <%- includeAttrs(actionAttrs); %> <%- includeClasses(actionClasses); %>><% if (actionMarkup !== 'input') { %><%- actionLabel %></<%= actionMarkup %>><% } %>`,hn=`<%#
...
`,jn=[{names:["action"],partial:fn},{names:["paragraph"],partial:xn},{names:["responsive-img"],partial:hn},{names:["responsive-vid"],partial:vn},{names:["img"],partial:kn},{names:["pictogram"],partial:yn}],wn=`<%#
...
`,_n=[{names:["accordion"],partial:wn},{names:["accordions-group"],partial:Cn}],An=`<%#
# paramètres alert
...
`,Ln=[{names:["badge"],partial:In},{names:["badges-group"],partial:Pn}],$n=`<%#
...
`,En=[{names:["breadcrumb"],partial:$n}],Tn=`<%#
...
<% } %>
`,Dn=[{names:["button-close"],partial:Tn},{names:["buttons-group"],partial:Sn},{names:["button-display"],partial:Gn},{names:["button"],partial:Mn}],zn=`<%#
...
`,Bn=[{names:["callout"],partial:zn}],Fn=`<%#
...
`,Jn=[{names:["card"],partial:Fn},{names:["card-content"],partial:Nn},{names:["card-details"],partial:On},{names:["card-end"],partial:Rn},{names:["card-header"],partial:Vn},{names:["card-footer"],partial:Wn},{names:["card-start"],partial:Un}],Hn=`<%#
...
`,Qn=[{names:["checkbox-group"],partial:Hn},{names:["checkbox"],partial:Xn}],Zn=`<%#
# paramètres connect
...
<% } %>
`,Kn=[{names:["connect"],partial:Zn}],Yn=`<%#
...
`,tt=[{names:["consent-banner"],partial:Yn},{names:["consent-manager"],partial:et},{names:["consent-placeholder"],partial:nt}],at=`<%#
# paramètres content
...
<% } %>
`,it=[{names:["content-media"],partial:at}],st=`<%#
# paramètres follow
...
`,ot=[{names:["follow"],partial:st},{names:["newsletter"],partial:rt},{names:["socials"],partial:lt}],dt=`<%#
# paramètres footer
...
`,gt=[{names:["footer"],partial:dt},{names:["footer-bottom"],partial:ut},{names:["footer-top"],partial:ct},{names:["footer-content"],partial:pt},{names:["footer-brand"],partial:mt},{names:["footer-partners"],partial:bt}],ft=`<%#
...
`,Ct=[{names:["label"],partial:ft},{names:["hint"],partial:ht},{names:["fieldset"],partial:vt},{names:["fieldset-element"],partial:xt},{names:["legend"],partial:kt},{names:["messages-group"],partial:jt},{names:["message"],partial:wt},{names:["form"],partial:yt}],_t=`<%#
# paramètres header
...
`,$t=[{names:["header-body"],partial:At},{names:["header-brand"],partial:qt},{names:["header-menu"],partial:It},{names:["header-navbar"],partial:Pt},{names:["header-tools"],partial:Lt},{names:["header"],partial:_t}],Et=`<%#
...
`,Tt=[{names:["highlight"],partial:Et}],St=`<%#
...
`,Mt=[{names:["input-group"],partial:St},{names:["input"],partial:Gt}],Dt=`<%#
# paramètres link
...
`,Bt=[{names:["link"],partial:Dt},{names:["links-group"],partial:zt}],Ft=`<%#
# paramètres logo
...
`,Vt=[{names:["buttonModal"],partial:Ot},{names:["modal"],partial:Rt}],Wt=`<%#
...
`,Zt=[{names:["navigation-btn"],partial:Ut},{names:["navigation-link"],partial:Jt},{names:["navigation-leader"],partial:Xt},{names:["navigation-mega-menu"],partial:Qt},{names:["navigation-menu"],partial:Ht},{names:["navigation"],partial:Wt}],Kt=`<%#
# paramètres notice
...
`,ta=[{names:["pagination"],partial:ea},{names:["pagination-item"],partial:na}],aa=`<%#
# paramètres password
...
`,ia=[{names:["password"],partial:aa}],sa=`<%#
# paramètres Quote
...
<% } %>
`,da=[{names:["radio-group"],partial:la},{names:["radio"],partial:oa}],ua=`<%#
# paramètres search
...
`,ba=[{names:["select-group"],partial:pa},{names:["select"],partial:ma}],ga=`<%#
# paramètres range
...
</div>`,xa=[{names:["segmented-element"],partial:va},{names:["segmented"],partial:ha}],ka=`<%#
# paramètres share
...
`,_a=[{names:["sidemenu-list"],partial:wa},{names:["sidemenu-menu"],partial:Ca},{names:["sidemenu"],partial:ja}],Aa=`<%#
# paramètres skiplink
...
`,qa=[{names:["skiplinks"],partial:Aa}],Ia=`<%#
...
`,Pa=[{names:["stepper"],partial:Ia}],La=`<%#
# paramètres summary
...
`,Ta=[{names:["summary"],partial:La},{names:["summary-list"],partial:$a},{names:["summary-item"],partial:Ea}],Sa=`<%#
# paramètres Tab
...
`,Da=[{names:["tab"],partial:Sa},{names:["tab-panel"],partial:Ga},{names:["tabs"],partial:Ma}],za=`<%#
...
`,Oa=[{names:["table-wrapper"],partial:za},{names:["table"],partial:Ba},{names:["thead"],partial:Fa},{names:["tbody"],partial:Na}],Ra=`<%#
# paramètres tag
...
`,Wa=[{names:["tag"],partial:Ra},{names:["tags-group"],partial:Va}],Ua=`<%#
# paramètres tile
...
`,Ka=[{names:["tile"],partial:Ua},{names:["tile-content"],partial:Ja},{names:["tile-details"],partial:Ha},{names:["tile-end"],partial:Xa},{names:["tile-header"],partial:Qa},{names:["tile-start"],partial:Za}],Ya=`<%#
# paramètres toggle
...
`,ni=[{names:["toggle"],partial:Ya},{names:["toggle-group"],partial:ei}],ti=`<%#
...
<ul class="<%= prefix %>-menu__list">
  ...
  <% } %>
</ul>`,ii=[{names:["translate"],partial:ti},{names:["languages"],partial:ai}],si=`<%#
# paramètres tooltip
...
`,ri=[{names:["tooltip"],partial:si}],li=`<%#
...
`,oi=[{names:["transcription"],partial:li}],di=`<%#
# paramètres upload
...
`,ui=[{names:["upload"],partial:di}],d=new gn;jn.forEach(({names:a,partial:n})=>d.add(a,n));_n.forEach(({names:a,partial:n})=>d.add(a,n));qn.forEach(({names:a,partial:n})=>d.add(a,n));Ln.forEach(({names:a,partial:n})=>d.add(a,n));En.forEach(({names:a,partial:n})=>d.add(a,n));Dn.forEach(({names:a,partial:n})=>d.add(a,n));Bn.forEach(({names:a,partial:n})=>d.add(a,n));Jn.forEach(({names:a,partial:n})=>d.add(a,n));Qn.forEach(({names:a,partial:n})=>d.add(a,n));Kn.forEach(({names:a,partial:n})=>d.add(a,n));tt.forEach(({names:a,partial:n})=>d.add(a,n));it.forEach(({names:a,partial:n})=>d.add(a,n));ot.forEach(({names:a,partial:n})=>d.add(a,n));gt.forEach(({names:a,partial:n})=>d.add(a,n));Ct.forEach(({names:a,partial:n})=>d.add(a,n));$t.forEach(({names:a,partial:n})=>d.add(a,n));Tt.forEach(({names:a,partial:n})=>d.add(a,n));Mt.forEach(({names:a,partial:n})=>d.add(a,n));Bt.forEach(({names:a,partial:n})=>d.add(a,n));Nt.forEach(({names:a,partial:n})=>d.add(a,n));Vt.forEach(({names:a,partial:n})=>d.add(a,n));Zt.forEach(({names:a,partial:n})=>d.add(a,n));Yt.forEach(({names:a,partial:n})=>d.add(a,n));ta.forEach(({names:a,partial:n})=>d.add(a,n));ia.forEach(({names:a,partial:n})=>d.add(a,n));ra.forEach(({names:a,partial:n})=>d.add(a,n));da.forEach(({names:a,partial:n})=>d.add(a,n));fa.forEach(({names:a,partial:n})=>d.add(a,n));ca.forEach(({names:a,partial:n})=>d.add(a,n));ba.forEach(({names:a,partial:n})=>d.add(a,n));xa.forEach(({names:a,partial:n})=>d.add(a,n));ya.forEach(({names:a,partial:n})=>d.add(a,n));_a.forEach(({names:a,partial:n})=>d.add(a,n));qa.forEach(({names:a,partial:n})=>d.add(a,n));Pa.forEach(({names:a,partial:n})=>d.add(a,n));Ta.forEach(({names:a,partial:n})=>d.add(a,n));Da.forEach(({names:a,partial:n})=>d.add(a,n));Oa.forEach(({names:a,partial:n})=>d.add(a,n));Wa.forEach(({names:a,partial:n})=>d.add(a,n));Ka.forEach(({names:a,partial:n})=>d.add(a,n));ni.forEach(({names:a,partial:n})=>d.add(a,n));ii.forEach(({names:a,partial:n})=>d.add(a,n));ri.forEach(({names:a,partial:n})=>d.add(a,n));oi.forEach(({names:a,partial:n})=>d.add(a,n));ui.forEach(({names:a,partial:n})=>d.add(a,n));export{d as e,pn as u};
