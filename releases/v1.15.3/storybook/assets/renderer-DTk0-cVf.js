...
`;i.escapeXML=function(p){return p==null?"":String(p).replace(E,P)},i.escapeXML.toString=function(){return Function.prototype.toString.call(this)+`;
`+y},i.shallowCopy=function(p,m){if(m=m||{},p!=null)for(var g in m)l(m,g)&&(g==="__proto__"||g==="constructor"||(p[g]=m[g]));return p},i.shallowCopyFromList=function(p,m,g){if(g=g||[],m=m||{},p!=null)for(var w=0;w<g.length;w++){var q=g[w];if(typeof m[q]<"u"){if(!l(m,q)||q==="__proto__"||q==="constructor")continue;p[q]=m[q]}}return p},i.cache={_data:{},set:function(p,m){this._data[p]=m},get:function(p){return this._data[p]},remove:function(p){delete this._data[p]},reset:function(){this._data={}}},i.hyphenToCamel=function(p){return p.replace(/-[a-z]/g,function(m){return m[1].toUpperCase()})},i.createNullProtoObjWherePossible=function(){return typeof Object.create=="function"?function(){return Object.create(null)}:{__proto__:null}instanceof Object?function(){return{}}:function(){return{__proto__:null}}}()})(V);var oe="3.1.8",ce={version:oe};(function(i){/**
 * @file Embedded JavaScript templating engine. {@link http://ejs.co}
 * @author Matthew Eernisse <mde@fleegix.org>
 * @author Tiancheng "Timothy" Gu <timothygu99@gmail.com>
 * @project EJS
 * @license {@link http://www.apache.org/licenses/LICENSE-2.0 Apache License, Version 2.0}
 */var d=_,u=re,l=V,x=!1,E=ce.version,P="<",y=">",p="%",m="locals",g="ejs",w="(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",q=["delimiter","scope","context","debug","compileDebug","client","_with","rmWhitespace","strict","filename","async"],ue=q.concat("cache"),W=/^\uFEFF/,B=/^[a-zA-Z_$][0-9a-zA-Z_$]*$/;i.cache=l.cache,i.fileLoader=d.readFileSync,i.localsName=m,i.promiseImpl=new Function("return this;")().Promise,i.resolveInclude=function(t,s,e){var r=u.dirname,o=u.extname,b=u.resolve,v=b(e?s:r(s),t),I=o(t);return I||(v+=".ejs"),v};function U(t,s){var e;if(s.some(function(r){return e=i.resolveInclude(t,r,!0),d.existsSync(e)}))return e}function pe(t,s){var e,r,o=s.views,b=/^[A-Za-z]+:\\|^\//.exec(t);if(b&&b.length)t=t.replace(/^\/*/,""),Array.isArray(s.root)?e=U(t,s.root):e=i.resolveInclude(t,s.root||"/",!0);else if(s.filename&&(r=i.resolveInclude(t,s.filename),d.existsSync(r)&&(e=r)),!e&&Array.isArray(o)&&(e=U(t,o)),!e&&typeof s.includer!="function")throw new Error('Could not find the include file "'+s.escapeFunction(t)+'"');return e}function $(t,s){var e,r=t.filename,o=arguments.length>1;if(t.cache){if(!r)throw new Error("cache option requires a filename");if(e=i.cache.get(r),e)return e;o||(s=J(r).toString().replace(W,""))}else if(!o){if(!r)throw new Error("Internal EJS error: no file name or template provided");s=J(r).toString().replace(W,"")}return e=i.compile(s,t),t.cache&&i.cache.set(r,e),e}function me(t,s,e){var r;if(e){try{r=$(t)(s)}catch(o){return e(o)}e(null,r)}else{if(typeof i.promiseImpl=="function")return new i.promiseImpl(function(o,b){try{r=$(t)(s),o(r)}catch(v){b(v)}});throw new Error("Please provide a callback function")}}function J(t){return i.fileLoader(t)}function be(t,s){var e=l.shallowCopy(l.createNullProtoObjWherePossible(),s);if(e.filename=pe(t,e),typeof s.includer=="function"){var r=s.includer(t,e.filename);if(r&&(r.filename&&(e.filename=r.filename),r.template))return $(e,r.template)}return $(e)}function H(t,s,e,r,o){var b=s.split(`
...
`,k.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),k}var D=e.client?s:function(X){var fe=function(he,Z){var F=l.shallowCopy(l.createNullProtoObjWherePossible(),X);return Z&&(F=l.shallowCopy(F,Z)),be(he,e)(F)};return s.apply(e.context,[X||l.createNullProtoObjWherePossible(),b,fe,H])};if(e.filename&&typeof Object.defineProperty=="function"){var M=e.filename,ge=u.basename(M,u.extname(M));try{Object.defineProperty(D,"name",{value:ge,writable:!1,enumerable:!1,configurable:!0})}catch{}}return D},generateSource:function(){var t=this.opts;t.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
...
`;break;case f.modes.ESCAPED:this.source+="    ; __append(escapeFn("+Q(t)+`))
`;break;case f.modes.RAW:this.source+="    ; __append("+Q(t)+`)
...
`)}},i.escapeXML=l.escapeXML,i.__express=i.renderFile,i.VERSION=E,i.name=g,typeof window<"u"&&(window.ejs=i)})(h);var de=h;return de})})(K);var pn=K.exports;const mn=ve(pn);let bn=0;const gn=a=>`${a}-${bn++}`,fn=`
...
<%
  ...
  const pictogramData = pictograms.filter(p => p.name === pictogram.name)[0];
  const category = pictogram.category || (pictogramData ? pictogramData.category : undefined);
...
<%
  ...
  const markup = accordion.markup || 'h3';
  const collapseClasses = [\`\${prefix}-collapse\`];
  if (isExpanded) collapseClasses.push(\`\${prefix}-collapse--expanded\`);
  const collapseAttributes = { ...accordion.collapseAttributes ?? {}, id: accordion.id };
 %>

<section class="<%= prefix %>-accordion">
  <<%= markup %> class="<%= prefix %>-accordion__title">
  ...
  <div <%- includeClasses(collapseClasses) %> <%- includeAttrs(collapseAttributes); %>>
...
`,Sn=[{names:["badge"],partial:En},{names:["badges-group"],partial:Tn}],$n=`<%#
...
`,Gn=[{names:["breadcrumb"],partial:$n}],Mn=`<%#
...
`,Xn=[{names:["card"],partial:Rn},{names:["card-content"],partial:Vn},{names:["card-details"],partial:Wn},{names:["card-end"],partial:Un},{names:["card-header"],partial:Jn},{names:["card-footer"],partial:Hn},{names:["card-start"],partial:Qn}],Zn=`<%#
...
switch(connect.variant) {
  ...
  case 'pro':
    connectClasses.push(prefix + '-connect--pro');
  break;
}
...
`,ut=[{names:["follow"],partial:ot},{names:["newsletter"],partial:ct},{names:["socials"],partial:dt}],pt=`<%#
# paramètres footer
...
`,$t=[{names:["header-body"],partial:Pt},{names:["header-brand"],partial:Lt},{names:["header-menu"],partial:Et},{names:["header-navbar"],partial:Tt},{names:["header-tools"],partial:St},{names:["header"],partial:It}],Gt=`<%#
...
if (input.valid) {
  ...
  if (!input.hasGroup) classes.push(\`\${prefix}-input--valid\`);
}
if (input.error) {
  builder.addError(input.error);
  if (!input.hasGroup) classes.push(\`\${prefix}-input--error\`);
}
...
* link.inText (boolean, optional) : si valeur true, n'ajoute pas la classe fr-link
...
if (!link.inText) linkClasses.push(prefix + '-link');
const markup = link.markup || 'a';
...
`,ea=[{names:["navigation-btn"],partial:Qt},{names:["navigation-link"],partial:Xt},{names:["navigation-leader"],partial:Kt},{names:["navigation-mega-menu"],partial:Yt},{names:["navigation-menu"],partial:Zt},{names:["navigation"],partial:Ht}],na=`<%#
# paramètres notice
...
<div <%- includeAttrs(attributes); %> <%- includeClasses(classes); %>>
  <div class="<%= prefix %>-container">
    <div class="<%= prefix %>-notice__body">
      <div>
        <% if (title) { %>
          <<%= markup %> <%- includeClasses(titleClasses) %>><%- title %></<%= markup %>>
        <% } %>
        <% if (desc) { %>
          <p class="<%= prefix %>-notice__desc"><%- desc %></p>
        <% } %>
        <% if (link) { %>
...
<% } %>
`,pa=[{names:["radio-group"],partial:da},{names:["radio"],partial:ua}],ma=`<%#
# paramètres search
...
if (search.labelled) searchClasses.push(prefix + '-search-bar--labelled');
...
`,La=[{names:["skiplinks"],partial:Pa}],Ea=`<%#
...
`,Ta=[{names:["stepper"],partial:Ea}],Sa=`<%#
# paramètres summary
...
`,Ma=[{names:["summary"],partial:Sa},{names:["summary-list"],partial:$a},{names:["summary-item"],partial:Ga}],Da=`<%#
# paramètres Tab
...
`,Ha=[{names:["tag"],partial:Ua},{names:["tags-group"],partial:Ja}],Qa=`<%#
# paramètres tile
...
`,ni=[{names:["tile"],partial:Qa},{names:["tile-content"],partial:Xa},{names:["tile-details"],partial:Za},{names:["tile-end"],partial:Ka},{names:["tile-header"],partial:Ya},{names:["tile-start"],partial:ei}],ti=`<%#
# paramètres toggle
...
`,ci=[{names:["tooltip"],partial:oi}],di=`<%#
...
`,ui=[{names:["transcription"],partial:di}],pi=`<%#
# paramètres upload
...
`,mi=[{names:["upload"],partial:pi}],c=new vn;_n.forEach(({names:a,partial:n})=>c.add(a,n));In.forEach(({names:a,partial:n})=>c.add(a,n));Ln.forEach(({names:a,partial:n})=>c.add(a,n));Sn.forEach(({names:a,partial:n})=>c.add(a,n));Gn.forEach(({names:a,partial:n})=>c.add(a,n));Fn.forEach(({names:a,partial:n})=>c.add(a,n));On.forEach(({names:a,partial:n})=>c.add(a,n));Xn.forEach(({names:a,partial:n})=>c.add(a,n));Yn.forEach(({names:a,partial:n})=>c.add(a,n));nt.forEach(({names:a,partial:n})=>c.add(a,n));st.forEach(({names:a,partial:n})=>c.add(a,n));lt.forEach(({names:a,partial:n})=>c.add(a,n));ut.forEach(({names:a,partial:n})=>c.add(a,n));vt.forEach(({names:a,partial:n})=>c.add(a,n));qt.forEach(({names:a,partial:n})=>c.add(a,n));$t.forEach(({names:a,partial:n})=>c.add(a,n));Mt.forEach(({names:a,partial:n})=>c.add(a,n));Bt.forEach(({names:a,partial:n})=>c.add(a,n));Ot.forEach(({names:a,partial:n})=>c.add(a,n));Vt.forEach(({names:a,partial:n})=>c.add(a,n));Jt.forEach(({names:a,partial:n})=>c.add(a,n));ea.forEach(({names:a,partial:n})=>c.add(a,n));ta.forEach(({names:a,partial:n})=>c.add(a,n));sa.forEach(({names:a,partial:n})=>c.add(a,n));la.forEach(({names:a,partial:n})=>c.add(a,n));ca.forEach(({names:a,partial:n})=>c.add(a,n));pa.forEach(({names:a,partial:n})=>c.add(a,n));xa.forEach(({names:a,partial:n})=>c.add(a,n));ba.forEach(({names:a,partial:n})=>c.add(a,n));ha.forEach(({names:a,partial:n})=>c.add(a,n));ja.forEach(({names:a,partial:n})=>c.add(a,n));Ca.forEach(({names:a,partial:n})=>c.add(a,n));Ia.forEach(({names:a,partial:n})=>c.add(a,n));La.forEach(({names:a,partial:n})=>c.add(a,n));Ta.forEach(({names:a,partial:n})=>c.add(a,n));Ma.forEach(({names:a,partial:n})=>c.add(a,n));Fa.forEach(({names:a,partial:n})=>c.add(a,n));Wa.forEach(({names:a,partial:n})=>c.add(a,n));Ha.forEach(({names:a,partial:n})=>c.add(a,n));ni.forEach(({names:a,partial:n})=>c.add(a,n));ii.forEach(({names:a,partial:n})=>c.add(a,n));li.forEach(({names:a,partial:n})=>c.add(a,n));ci.forEach(({names:a,partial:n})=>c.add(a,n));ui.forEach(({names:a,partial:n})=>c.add(a,n));mi.forEach(({names:a,partial:n})=>c.add(a,n));export{c as e,gn as u};
