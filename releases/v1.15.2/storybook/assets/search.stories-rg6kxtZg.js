import{e as b}from"./renderer-aLkn78UT.js";import"./_commonjsHelpers-BosuxZz1.js";const g=e=>b.render("search",e),m={buttonLabel:{control:"text",description:"Libellé du bouton",type:{value:"string",required:!0},table:{category:"button"}},buttonTitle:{control:"text",description:"Titre du bouton",type:{value:"string",required:!0},table:{category:"button"}}},y={inputId:{control:"text",description:"Attribut 'id' de l'input",type:{value:"string",required:!0},table:{category:"input"}},inputLabel:{control:"text",description:"Libellé de l'input",type:{value:"string",required:!0},table:{category:"input"}},inputPlaceholder:{control:"text",description:"Placeholder de l'input",type:{value:"string"},table:{category:"input"}}},S={size:{control:{type:"select"},description:"Taille de la barre de recherche (défaut: md)",options:["md","lg"]},...y,...m},t={size:"md",inputId:"search-input",inputLabel:"Rechercher",inputPlaceholder:"Rechercher",buttonTitle:"Rechercher",buttonLabel:"Rechercher"},L=e=>({id:e.id||void 0,size:e.size||t.size,input:{id:e.inputId||t.inputId,label:e.inputLabel||t.inputLabel,placeholder:e.inputPlaceholder||t.inputPlaceholder},button:{label:e.buttonLabel||t.buttonLabel,title:e.buttonTitle||t.buttonTitle,type:"submit"}}),T=e=>g({search:L(e)}),x={id:"search",title:"DSFR/Component/Search",render:T,argTypes:S,args:t},r={tags:["!autodocs"],args:{}},o={tags:["autodocs","!dev"],args:{id:"search-md",inputId:"search-input-md"}},s={tags:["autodocs","!dev"],args:{size:"lg",id:"search-lg",inputId:"search-input-lg"}};var a,n,c;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {}
