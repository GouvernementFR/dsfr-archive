import{a}from"./checkbox-arg-types-Bfp5TreK.js";import{f as r,a as h}from"./form-arg-types-BB7YawXK.js";import{u as U}from"./renderer-aLkn78UT.js";import{r as V}from"./fieldset-BRIKuE75.js";import"./_commonjsHelpers-BosuxZz1.js";const W={id:{...h.id,type:{value:"string",required:!0}},legend:{...h.legend,description:"Légende de l’ensemble des checkboxes"},hint:{...a.hint,description:"Texte additionnel sous la légende"},size:{...a.size,description:"Taille des checkboxes"},inline:{...h.inline},disabled:{...a.disabled,description:"Désactive l’ensemble des checkboxes"},status:{...a.status},errorMessage:{...a.errorMessage},validMessage:{...a.validMessage}},s=(e=3,x=!1)=>{const o=[];for(let t=1;t<=e;t++)o.push({label:`Checkbox ${t}`,id:U("checkbox"),name:`checkbox${t}`,hint:x?"Texte additionnel":"",disabled:!1});return o},X={legend:"Légende pour l’ensemble des éléments",hint:r.hint,size:"md",disabled:r.disabled,inline:r.inline,status:"default",errorMessage:"Texte d’erreur",validMessage:"Texte de succès",checkboxes:s(),id:r.id},Y=e=>({id:e.id||U("checkbox-form"),legend:e.legend,disabled:e.disabled,hint:e.hint!==""?e.hint||r.hint:void 0,inline:e.inline,choice:!0,status:e.status||r.status,error:e.status==="error"?e.errorMessage||r.errorMessage:void 0,valid:e.status==="valid"?e.validMessage||r.validMessage:void 0,elements:e.checkboxes.map((o,t)=>({type:"checkbox",inline:e.inline,data:{label:o.label,size:e.size,id:o.id,name:o.name,hint:o.hint,disabled:o.disabled}}))}),Z=e=>V({fieldset:Y(e)}),ce={id:"checkboxes-group",title:"DSFR/Component/Checkbox/Checkboxes-Group",render:Z,argTypes:W,args:X},c={tags:["!autodocs"],args:{}},n={tags:["autodocs","!dev"],args:{checkboxes:s()}},d={tags:["autodocs","!dev"],args:{hint:"Texte de description additionnel",checkboxes:s()}},i={tags:["autodocs","!dev"],args:{checkboxes:s(3,!0)}},u={tags:["autodocs","!dev"],args:{inline:!0,checkboxes:s(2)}},l={tags:["autodocs","!dev"],args:{size:"md",checkboxes:s()}},p={tags:["autodocs","!dev"],args:{size:"sm",checkboxes:s()}},g={tags:["autodocs","!dev"],args:{checkboxes:s(),disabled:!0}},m={tags:["autodocs","!dev"],args:{status:"error",checkboxes:s()}},b={tags:["autodocs","!dev"],args:{status:"valid",checkboxes:s()}};var k,S,v;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  args: {}
